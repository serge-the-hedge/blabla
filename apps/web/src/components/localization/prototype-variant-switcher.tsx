...
export function PrototypeVariantSwitcher({
	...
	return (
		<div className="-translate-x-1/2 fixed bottom-4 left-1/2 z-50 flex items-center gap-1 rounded-full border border-foreground/20 bg-foreground px-1.5 py-1.5 text-background shadow-lg">
			<Button
				size="icon-sm"
				variant="ghost"
